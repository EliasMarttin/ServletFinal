...
@WebServlet(name = "ServletEliminaViaje", value = "/ServletEliminaViaje")
public class ServletEliminaViaje extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher vista = request.getRequestDispatcher("resEliminaViaje.jsp");
        vista.forward(request, response);
    }
}
