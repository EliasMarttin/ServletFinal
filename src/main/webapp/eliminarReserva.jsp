...
<div id="divlistadoMain">
    <form action = "ServletEliminaReserva" method="GET">
        <label>Indica el Codigo del viaje que quieres eliminar la reserva </label><input type="text" name="codViaje" required>
